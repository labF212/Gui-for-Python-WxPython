...
class MainFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.gauge_umid = wx.Gauge(self.panel, range=80, size=(300, 20), style=wx.GA_HORIZONTAL|wx.GA_SMOOTH)
        font = wx.Font(10, wx.DEFAULT, wx.NORMAL, wx.NORMAL)
        self.gauge_temp.SetFont(font)
        self.gauge_umid.SetFont(font)
        ...
        self.list_ctrl.InsertColumn(3, "Umidade")
